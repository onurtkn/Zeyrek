...
namespace TrayIcon
{
    static class Helper
    {
        ...
        public static string getSerialNumberOfPc()
        {
            ManagementObjectSearcher MOS = new ManagementObjectSearcher("Select * From Win32_BaseBoard");
            string serialno = "";
            foreach (ManagementObject getserial in MOS.Get())
            {
                string s = getserial.GetText(TextFormat.WmiDtd20);
                serialno = getserial["SerialNumber"].ToString();
            }
        ...
        public static string getMonitorID()
        {
            ...
            foreach (ManagementObject getserial in MOS.Get())
            {
                if (getserial["DeviceID"] != null)
                    serialno = getserial["DeviceID"].ToString();
            }
